...
abstract class AbstractModel extends ModelBase {
    ...
    static public function init_examine($tablist, $options, $dbhandle) {
        $schema = new SchemaDatabase($tablist, $options, $dbhandle);
        return $schema;
    }

    static public function init_create_models() {
        # nothing to do for this implementation, SchemaDatabase handles this
        return;
    }
